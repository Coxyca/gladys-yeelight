...
module.exports = function setup() {
        ...
        socket.on('listening', function() {
            console.log('Searching for Yeelight bulbs. Please wait...');
            console.log('Broadcasting socket to ' + ssdp_address + '...');
        ...
        return new Promise(function(resolve, reject) {
            ...
            setTimeout(function() {
                socket.close();
                console.log(Object.keys(bulbs).length + " Yeelight bulbs found");
                ...
                return Promise.map(Object.keys(bulbs), function(id) {
                    return gladys.device.create({
                        ...
                        console.log("Added bulb " + id + " (" + bulbs[id].location.host + ") to devices list");
                    });
                }).then(() => {
                    init();
                    console.log("Setting is done. You can now control your bulbs through Gladys devices pannel");
                    resolve();
                });
            }, 10000);
